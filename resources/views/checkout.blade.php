...
<div class="container">
    <div class="row">
        <div class="col-md-5 offset-md-1">
            ...
            <hr>
            <h3 class="lead" style="font-size: 1.2em; margin-bottom: 1.6em;">Detalles de envio</h3>
            <form action="{{ route('checkout.store') }}" method="POST">
                @csrf()
                <div class="form-group">
                    <label for="email" class="light-text">Correo Electronico</label>
                    @guest
                ...
                <div class="form-group">
                    <label for="name" class="light-text">Nombre</label>
                    <input type="text" name="name" class="form-control my-input" required>
                </div>
                <div class="form-group">
                    <label for="address" class="light-text">Direccion</label>
                    <input type="text" name="address" class="form-control my-input" required>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="city" class="light-text">Ciudad</label>
                            <input type="text" name="city" class="form-control my-input" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="province" class="light-text">Provincia</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="phone" class="light-text">Telefono</label>
                        <input type="text" name="phone" class="form-control my-input" required>
                    </div>
                </div>
                <h2 style="margin-top:1em; margin-bottom:1em;">Metodo de Pago</h2>
                <div class="form-group">
                    <label for="name_on_card" class="light-text">Nombre</label>
                ...
                <button type="submit" class="btn btn-success custom-border-success btn-block">Completar orden</button>
            </form>
        </div>
        <div class="col-md-5 offset-md-1">
            <hr>
