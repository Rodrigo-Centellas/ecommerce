...
<div class="container">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            ...
            <h3 class="lead mt-4">{{ Cart::instance('default')->count() }} Productos en tu carrito</h3>
            ...
            <div class="cart-actions">
                <a class="btn custom-border-n" href="{{ route('shop.index') }}">Seguir comprando</a>
                <a class="float-right btn btn-success custom-border-n" href="{{ route('checkout.index') }}">
                    Seguir con el check out
                </a>
            </div>
            @else
            <div class="alert alert-info">
                <h4 class="lead">Sin items en el carrito <a class="btn custom-border-n" href="{{ route('shop.index') }}">Continuar compra</a></h4>
            </div>
            @endif
            <hr>
            @if (Cart::instance('saveForLater')->count() > 0)
                <h3 class="lead">{{ Cart::instance('saveForLater')->count() }} Item guardado para despues</h3>
                <table class="table table-responsive">
                    <tbody>
